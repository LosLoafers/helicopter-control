...
const Qr = [2.0 zeros(1,8) 2.5 zeros(1,8) 2.0 zeros(1,8) 2.0 zeros(1,36)]
const Rr = [1.0 0.0 0.0 5.0]*10
...
function cvxsolve(x,r)
    (Asystem,Bsystem,LinearizationPoint_x,LinearizationPoint_u)=linearDescreteModelGen(x[1],x[2],x[7],x[8],Ts_control)

#setup opt problem
    reference=[r;0;0;0;0;0;0]
    param_x_0=x-LinearizationPoint_x
    ...
    param_r=(reference-LinearizationPoint_x)'
...
function linearDescreteModelGen(x1,x2,x7,x8,Ts)
