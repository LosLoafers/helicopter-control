  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==6) {
    c6_kalman_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3387011862U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1399161806U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3324101796U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(690641396U);
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3271403397U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1673403272U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1366016496U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(664620285U);
      ...
      switch (chartFileNumber) {
       ...
       case 6:
        {
          extern void sf_c6_kalman_get_check_sum(mxArray *plhs[]);
          sf_c6_kalman_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4159095538U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1027165706U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2967122657U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1404514222U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "qbyB10UptW9AY36xEtDadC") == 0) {
     ...
     case 4:
      {
        if (strcmp(aiChksum, "aag7fLuop0yqEyz0IQ78CE") == 0) {
     ...
     case 5:
      {
        if (strcmp(aiChksum, "AtUMVmYE5AAUUhyCn84bzC") == 0) {
     ...
     case 6:
      {
        if (strcmp(aiChksum, "FMUmHsVbuyxgqLPzL4RBh") == 0) {
          extern mxArray *sf_c6_kalman_get_autoinheritance_info(void);
          plhs[0] = sf_c6_kalman_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        extern const mxArray *sf_c6_kalman_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c6_kalman_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
void kalman_debug_initialize(void)
{
  _kalmanMachineNumber_ = sf_debug_initialize_machine("kalman","sfun",0,6,0,0,0);
  sf_debug_set_machine_event_thresholds(_kalmanMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds(_kalmanMachineNumber_,0);
}
