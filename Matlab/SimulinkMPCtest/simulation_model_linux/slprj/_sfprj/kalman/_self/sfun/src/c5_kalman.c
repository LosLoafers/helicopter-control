...
static const char * c5_debug_family_names[6] = { "nargin", "nargout", "th",
  "dth", "th_out", "dth_out" };
...
static real_T c5_emlrt_marshallIn(SFc5_kalmanInstanceStruct *chartInstance,
  const mxArray *c5_dth_out, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_kalmanInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_kalmanInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_kalmanInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  c5_b_hoistedGlobal = *c5_th_out;
  c5_b_u = c5_b_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = chartInstance->c5_is_active_c5_kalman;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_th_out = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    1)), "th_out");
  chartInstance->c5_is_active_c5_kalman = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 2)), "is_active_c5_kalman");
  sf_mex_destroy(&c5_u);
  ...
  const mxArray *c5_dth_out, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_dth_out), &c5_thisId);
  sf_mex_destroy(&c5_dth_out);
  return c5_y;
}
...
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  const mxArray *c5_dth_out;
  const char_T *c5_identifier;
  emlrtMsgIdentifier c5_thisId;
  real_T c5_y;
  SFc5_kalmanInstanceStruct *chartInstance;
  chartInstance = (SFc5_kalmanInstanceStruct *)chartInstanceVoid;
  c5_dth_out = sf_mex_dup(c5_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3489029374U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1973874850U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(557925706U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(25336899U);
}
...
mxArray *sf_c5_kalman_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("AtUMVmYE5AAUUhyCn84bzC");
...
static const mxArray *sf_get_sim_state_info_c5_kalman(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[7],T\"dth_out\",},{M[1],M[5],T\"th_out\",},{M[8],M[0],T\"is_active_c5_kalman\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,41,61,100,146);

        {
          static int condStart[] = { 44, 55 };

          static int condEnd[] = { 53, 60 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,44,60,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c5_kalman(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2793513198U));
  ssSetChecksum1(S,(2777750420U));
  ssSetChecksum2(S,(2181847102U));
  ssSetChecksum3(S,(1393011861U));
...
{
  SFc5_kalmanInstanceStruct *chartInstance;
  chartInstance = (SFc5_kalmanInstanceStruct *)malloc(sizeof
