...
#include "LinuxMPC_sfun_debug_macros.h"
...
static void initialize_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void initialize_params_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct
  *chartInstance);
static void enable_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void disable_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct
  *chartInstance);
static void set_sim_state_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void finalize_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void sf_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void c4_chartstep_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void initSimStructsc4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c4_dw2, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_LinuxMPCInstanceStruct *chartInstance,
...
static void c4_eml_scalar_eg(SFc4_LinuxMPCInstanceStruct *chartInstance);
static real_T c4_mpower(SFc4_LinuxMPCInstanceStruct *chartInstance, real_T c4_a);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_LinuxMPC, const char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_LinuxMPCInstanceStruct *chartInstance);
...
static void initialize_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_LinuxMPC = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_e_hoistedGlobal = chartInstance->c4_is_active_c4_LinuxMPC;
  ...
  const mxArray *c4_st)
{
  ...
  *c4_dw2 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 3)),
    "dw2");
  chartInstance->c4_is_active_c4_LinuxMPC = c4_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 4)), "is_active_c4_LinuxMPC");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_LinuxMPC(chartInstance);
...
static void sf_c4_LinuxMPC(SFc4_LinuxMPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_LinuxMPC(chartInstance);
  sf_debug_check_for_state_inconsistency(_LinuxMPCMachineNumber_,
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u;
  const mxArray *c4_y = NULL;
  SFc4_LinuxMPCInstanceStruct *chartInstance;
  chartInstance = (SFc4_LinuxMPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_LinuxMPC_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c4_b_is_active_c4_LinuxMPC, const char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_LinuxMPC), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_LinuxMPC);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_LinuxMPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(711994511U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3399932245U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(581215108U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(221000265U);
}

mxArray *sf_c4_LinuxMPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("v5wOM0Xu9imk4J4oYQSfR");
...
static const mxArray *sf_get_sim_state_info_c4_LinuxMPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"ddph\",},{M[1],M[12],T\"ddth\",},{M[1],M[13],T\"dw1\",},{M[1],M[14],T\"dw2\",},{M[8],M[0],T\"is_active_c4_LinuxMPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_LinuxMPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_LinuxMPCInstanceStruct *chartInstance;
    chartInstance = (SFc4_LinuxMPCInstanceStruct *) ((ChartInfoStruct *)
      (ssGetUserData(S)))->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        unsigned int chartAlreadyPresent;
        chartAlreadyPresent = sf_debug_initialize_chart(_LinuxMPCMachineNumber_,
          4,
          1,
          1,
          11,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_LinuxMPCMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_LinuxMPCMachineNumber_,
            chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_LinuxMPCMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1904);
        _SFD_CV_INIT_EML_IF(0,1,0,1859,1888,-1,1904);

        {
          static int condStart[] = { 1862, 1873, 1881 };

          static int condEnd[] = { 1871, 1879, 1887 };

          static int pfixExpr[] = { 0, 1, -3, 2, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,1862,1887,3,0,&(condStart[0]),&(condEnd[0]),
                                5,&(pfixExpr[0]));
        }
      ...
      sf_debug_reset_current_state_configuration(_LinuxMPCMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}
...
{
  return "aV0bHwmbzxIk4e9C2QQLsE";
}

static void sf_opaque_initialize_c4_LinuxMPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
  initialize_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_LinuxMPC(void *chartInstanceVar)
{
  enable_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_LinuxMPC(void *chartInstanceVar)
{
  disable_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_LinuxMPC(void *chartInstanceVar)
{
  sf_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_LinuxMPC(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_LinuxMPC();/* state var info */
...
extern void sf_internal_set_sim_state_c4_LinuxMPC(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_LinuxMPC(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_LinuxMPC(S);
}

static void sf_opaque_set_sim_state_c4_LinuxMPC(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_LinuxMPC(S, st);
}

static void sf_opaque_terminate_c4_LinuxMPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_LinuxMPC_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_LinuxMPC(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_LinuxMPC((SFc4_LinuxMPCInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_LinuxMPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_LinuxMPC_optimization_info();
  ...
  ssSetChecksum0(S,(1996023572U));
  ssSetChecksum1(S,(3156943652U));
  ssSetChecksum2(S,(1187580073U));
  ssSetChecksum3(S,(2216256077U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c4_LinuxMPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_LinuxMPC(SimStruct *S)
{
  SFc4_LinuxMPCInstanceStruct *chartInstance;
  chartInstance = (SFc4_LinuxMPCInstanceStruct *)malloc(sizeof
    (SFc4_LinuxMPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_LinuxMPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_LinuxMPC;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_LinuxMPC;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_LinuxMPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_LinuxMPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_LinuxMPC;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_LinuxMPC;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_LinuxMPC;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_LinuxMPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_LinuxMPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_LinuxMPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_LinuxMPC;
...
void c4_LinuxMPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_LinuxMPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_LinuxMPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_LinuxMPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_LinuxMPC_method_dispatcher.\n"
