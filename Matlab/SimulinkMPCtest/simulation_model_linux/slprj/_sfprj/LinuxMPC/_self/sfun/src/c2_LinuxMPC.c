...
static void initialize_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance);
static void initialize_params_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct
  *chartInstance);
static void enable_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance);
static void disable_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct
  *chartInstance);
static void set_sim_state_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance);
static void sf_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance);
static void initSimStructsc2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_b_P, const char_T *c2_identifier, real_T c2_y[64]);
static void c2_b_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[64]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_b_x_hat, const char_T *c2_identifier, real_T c2_y[8]);
static void c2_d_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_f_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_b_x_hat, const char_T *c2_identifier, real_T c2_y[8]);
static void c2_g_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[8]);
static void c2_h_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_b_P, const char_T *c2_identifier, real_T c2_y[64]);
static void c2_i_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[64]);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_j_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_k_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_LinuxMPC, const char_T *c2_identifier);
static uint8_T c2_l_emlrt_marshallIn(SFc2_LinuxMPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_LinuxMPCInstanceStruct *chartInstance);
...
static void initialize_c2_LinuxMPC(SFc2_LinuxMPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_LinuxMPC = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_LinuxMPC;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_LinuxMPC = c2_k_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 3)), "is_active_c2_LinuxMPC");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_LinuxMPC(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[64];
  const mxArray *c2_y = NULL;
  SFc2_LinuxMPCInstanceStruct *chartInstance;
  chartInstance = (SFc2_LinuxMPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_LinuxMPC_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_LinuxMPC, const char_T *c2_identifier)
{
  ...
  c2_y = c2_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_LinuxMPC), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_LinuxMPC);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_LinuxMPC_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_LinuxMPC_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_LinuxMPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[9],T\"x\",},{M[4],M[0],T\"P\",S'l','i','p'{{M1x2[74 75],M[0],}}},{M[4],M[0],T\"x_hat\",S'l','i','p'{{M1x2[56 61],M[0],}}},{M[8],M[0],T\"is_active_c2_LinuxMPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_LinuxMPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_LinuxMPCInstanceStruct *chartInstance;
    chartInstance = (SFc2_LinuxMPCInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_LinuxMPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
  initialize_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_LinuxMPC(void *chartInstanceVar)
{
  enable_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_LinuxMPC(void *chartInstanceVar)
{
  disable_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_LinuxMPC(void *chartInstanceVar)
{
  sf_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_LinuxMPC(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_LinuxMPC();/* state var info */
...
extern void sf_internal_set_sim_state_c2_LinuxMPC(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_LinuxMPC(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_LinuxMPC(S);
}

static void sf_opaque_set_sim_state_c2_LinuxMPC(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_LinuxMPC(S, st);
}

static void sf_opaque_terminate_c2_LinuxMPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_LinuxMPC(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_LinuxMPC((SFc2_LinuxMPCInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_LinuxMPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_LinuxMPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_LinuxMPC(SimStruct *S)
{
  SFc2_LinuxMPCInstanceStruct *chartInstance;
  chartInstance = (SFc2_LinuxMPCInstanceStruct *)malloc(sizeof
    (SFc2_LinuxMPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_LinuxMPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_LinuxMPC;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_LinuxMPC;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_LinuxMPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_LinuxMPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_LinuxMPC;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_LinuxMPC;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_LinuxMPC;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_LinuxMPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_LinuxMPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_LinuxMPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_LinuxMPC;
...
void c2_LinuxMPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_LinuxMPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_LinuxMPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_LinuxMPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_LinuxMPC_method_dispatcher.\n"
