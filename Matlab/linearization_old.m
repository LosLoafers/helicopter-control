...
syms x1 x2 x3 x4 x5 x6 f1 f2 f3 f4 u1 u2  %sympolics of all variabels/sates and inputs
...
%forming the continious linear A matrix asuming x is a stationary point
A=[0 1 0 0 0 0;
...
%forming a functin from the symbolic expression 
Afunction=matlabFunction(A);

%returning the achived A matrix linearized around x.
A=Afunction(x20,x30,x40,x50,x60);


%B matrix (B was already linear so this was unnessesary.... :P )
