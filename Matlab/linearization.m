function [B,Afunction]=linearization(xpoint)
%constants
g=9.81;
l1=0.1995;
l2=0.1743;
...
Anonlin=matlabFunction(f);
u1=xpoint(5)*k1;
u2=xpoint(6)*k2;
Anonlin(u1,u2,xpoint(2),xpoint(3),xpoint(4),xpoint(5),xpoint(6))
